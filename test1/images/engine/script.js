...
function ws_seven(t, e, i) {
    ...
    function o(t, e, i, o, r) {
        ...
        return b > v && (v = b), y > x && (x = y), d(t).each(function(t) {
            ...
            // alert(b);
            // alert(t+' c.top:'+C.top+' c.left'+C.left+' c.width'+C.width+' c.height'+C.height);
            // alert(t+' E.top:'+E.top+' E.left'+E.left+' E.width'+E.width+' E.height'+E.height);
            // alert(t+' L.top:'+L.top+' L.left'+L.left+' L.width'+L.width+' L.height'+L.height);
            // alert(t+' Q.top:'+Q.top+' Q.left'+Q.left+' Q.width'+Q.width+' Q.height'+Q.height);
